...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="#" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" role="button"><i class="fas fa-sign-out-alt"></i></a>
      </li>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2014-{{ date('Y') }} IBS</strong>
    All rights reserved.
  </footer>
