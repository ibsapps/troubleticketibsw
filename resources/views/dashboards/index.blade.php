...
<div class="row">
  <section class="col-lg-8">
    ...
    <div class="row">
      ...
      <div class="col-lg-3">
        <a href="https://voucher.ibsmulti.com/" target="_blank">
          <div class="info-box">
      ...
      <div class="col-lg-3">
        <a href="http://atk.ibsmulti.com/ibs" target="_blank">
          <div class="info-box">
      ...
      <div class="col-lg-3">
        <a href="http://mis.ibsmulti.com/amonline" target="_blank">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-number">AM ONLINE</span>
            </div>
          </div>
        </a>
      </div>
